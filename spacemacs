...
layers configuration. You are free to put any user code."
  ...
  ;; Fix https://github.com/syl20bnr/spacemacs/issues/8027
  (require 'ansible-doc)

  ;; Remove when parinfer layer is added
